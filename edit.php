...
<body>
	...
	<div class="form_box">
		<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]) ?>" style='width:500px;' enctype='multipart/form-data'>
			...
			<input type="text" name="property_name" value="<?php if($flag){echo"$property_name";}?>">
			<p class="error"><?php echo $eproperty_name; ?></p>

			<label class="">Property id</label>
			<input type="text" name="property_id" value="<?php if($flag){echo"$property_id";}?>">
			<p class="error"><?php echo $eproperty_id; ?></p>

			<label class="">Description</label>
			<textarea name="description"><?php if($flag){echo $description;}?></textarea>
			<p class="error"><?php echo $edescription; ?></p>

			<label class="">City</label>
			<input type="text" name="city" value="<?php if($flag){echo $city ;}?>" >
			<p class="error"><?php echo $ecity; ?></p>

			<label class="">Address</label>
			<input type="text" name="address" value="<?php if($flag){echo"$address";}?>" >
			<p class="error"><?php echo $eaddress; ?></p>

			<label class="">Address link</label>
			<input type="text" name="address_link" maxlength="200" value="<?php if($flag){echo"$address_link";}?>">
			<p class="error"><?php echo $eaddress_link; ?></p>

			<label class="">Price</label>
			<input type="text" name="price" maxlength="20" value="<?php if($flag){echo"$price";}?>">
			...
			<input type="text" name="contact_number" pattern="[0-9]{10}" maxlength="10" placeholder="9898989898" value="<?php if($flag){echo"$contact_number";}?>">
			<p class="error"><?php echo $econtact_number; ?></p>

			<label class="">Dealers Email Id</label>
			<input type="email" name="contact_email" maxlength="20" value="<?php if($flag){echo"$contact_email";}?>">
